      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 14, marginBottom: 20 }}>
        ...
        <div className="fld" style={{ minWidth: 0 }}>
          ...
          {isNewBrand
            ...
            : <select value={manual.brand} disabled={!manual.pic_client} onChange={(e) => {
                if (e.target.value === NEW_OPTION) { toggleNewBrand(); return; }
                setIsNewStore(false); setManual((m) => ({ ...m, brand: e.target.value, store_name: "" }));
              }}>
        ...
        <div className="fld" style={{ minWidth: 0 }}>
          ...
          {isNewStore
            ...
            : <select value={manual.store_name} disabled={!manual.brand} onChange={(e) => {
                if (e.target.value === NEW_OPTION) { setIsNewStore(true); return; }
                setManual((m) => ({ ...m, store_name: e.target.value }));
              }}>
