...
export default function LoginPage() {
  ...
  // First-visit entry screen: pick Create Account vs Already Have Account
  ...
  return (
    ...
    >
      ...
      <div
        className="glass relative w-full max-w-xs rounded-2xl p-6"
        style={{ boxShadow: "0 25px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(201,162,39,0.1)" }}
      >
        <div className="mb-5 flex flex-col items-center gap-2">
          <Image src="/logo.png" alt="ProfTokoOnline" width={64} height={64} style={{ objectFit: "contain" }} priority />
          <div className="text-center">
            <h1 className="text-lg font-bold tracking-wide" style={{ color: "#e8edf8" }}>ProfTokoOnline</h1>
            <p className="mt-0.5 text-[11px]" style={{ color: "#7b8db0" }}>Dashboard Analytics</p>
          </div>
        </div>
        ...
        {mode === "choice" ? (
          <div className="space-y-3">
            <button
              ...
              style={{ background: "linear-gradient(135deg, #c9a227, #e8c84a)", color: "#0a1628", boxShadow: "0 4px 20px rgba(201,162,39,0.3)" }}
            >
              Create Account
            </button>
            <button
              ...
              className="w-full rounded-lg py-2.5 text-sm font-semibold tracking-wide transition-all"
              style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#e8edf8" }}
            >
          ...
          <form onSubmit={onSubmit} className="space-y-3.5">
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-medium uppercase tracking-widest" style={{ color: "#7b8db0" }}>
                Username or Email
              </label>
              <input
                type="text"
            ...
            {error && (
              <div className="rounded-lg px-3.5 py-2 text-xs" style={{ background: "rgba(239,68,68,0.1)", border: "1px solid rgba(239,68,68,0.2)", color: "#fca5a5" }}>
                {error}
              </div>
            )}
            ...
            <button
              ...
              style={{ background: "none", border: "none", color: "#7b8db0", cursor: "pointer", padding: "2px 0" }}
            >
              ← Back
            </button>
          </form>
        ...
        <p className="mt-5 text-center text-[11px]" style={{ color: "#4a5d7a" }}>
