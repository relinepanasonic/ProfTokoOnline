-- =====================================================================
-- 0039: Reset market_fees to the full 0038 schema
--
-- A simplified test table (only platform_fee_pct/komisi_dinamic_pct, 1 row)
-- was created by hand before 0038 was run — drop it and rebuild properly
-- with the full 11-field schema matching the real "Market Place Fee" sheet
-- tab's 18 columns (Category..Spay Later Xtra 6 mo).
-- =====================================================================
...
create index market_fees_client_idx on market_fees (client_id);
create index market_fees_platform_idx on market_fees (client_id, platform, jenis_toko);
...
create index market_fee_log_fee_idx on market_fee_log (market_fee_id);
create index market_fee_log_client_idx on market_fee_log (client_id, month);
