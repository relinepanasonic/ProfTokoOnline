-- =====================================================================
-- 0044: AVG Store Sales Performa — switch from "avg across stores, per
-- month" (a trend line) to "avg monthly sales, per store" (a bar per
-- store). For each store: total SPOS sales across its active (non-baseline)
-- months, divided by how many distinct months it actually has data for.
-- Example: Japarutomo has sales in Feb-Jun (5 months) totalling 1,000,000
-- -> avg_sales = 200,000.
-- =====================================================================
