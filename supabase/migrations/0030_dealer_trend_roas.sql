-- =====================================================================
-- 0030: Add per-month ad_cost to the dealer trend, so the frontend can
-- compute a ROAS sparkline (sales / ad_cost per month) next to the
-- existing sales trend. Keeps the single-scan `base` CTE from 0029 —
-- only the trend_by_store aggregation changes (spos + ads in one group).
-- =====================================================================
